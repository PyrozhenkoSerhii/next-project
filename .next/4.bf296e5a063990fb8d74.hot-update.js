...
function (_React$Component) {
  ...
  function View(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "decreaseCount", {
      ...
      writable: true,
      value: function value() {
        if (_this.state.localCount > 0) {
          var _count = _this.state.localCount - 1;
        }

        _this.setState({
          localCount: count ? count : _this.state.localCount
        });
      }
    });
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      }, "Increase"), this.state.localCount, __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_next_link___default.a, {
        href: "/product/order",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 65
...
//# sourceMappingURL=4.bf296e5a063990fb8d74.hot-update.js.map