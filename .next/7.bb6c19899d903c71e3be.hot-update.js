...
function (_React$Component) {
  ...
  _createClass(View, [{
    ...
    value: function getInitialProps(_ref) {
      ...
      var res = __WEBPACK_IMPORTED_MODULE_1_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_2__assets_config_api__["a" /* API_URL */] + __WEBPACK_IMPORTED_MODULE_2__assets_config_api__["b" /* PRODUCTS */] + 'getById', {
        method: 'POST',
        body: JSON.stringify({
          id: req.query.id
        }),
      ...
      }).then(function (product) {}); // const data = res.json();
      // console.log(data);
...
//# sourceMappingURL=7.bb6c19899d903c71e3be.hot-update.js.map