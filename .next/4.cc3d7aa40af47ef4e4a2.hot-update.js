...
function (_React$Component) {
  ...
  function View(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "decreaseCount", {
      ...
      enumerable: true,
      writable: true,
      value: function value() {// if (this.state.localCount > 0) {
        //     this.setState({
    ...
    Object.defineProperty(_assertThisInitialized(_this), "orderProduct", {
      ...
      enumerable: true,
      writable: true,
      value: function value() {// this.props.order(this.props.count);
      }
    });
    _this.state = {
      localCount: 0
  ...
  _createClass(View, [{
    key: "increaseCount",
    value: function increaseCount() {// this.setState({
      //     localCount: 1
      // })
    }
  }, {
...
//# sourceMappingURL=4.cc3d7aa40af47ef4e4a2.hot-update.js.map