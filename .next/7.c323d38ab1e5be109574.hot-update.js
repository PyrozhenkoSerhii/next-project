...
function (_React$Component) {
  ...
  _createClass(View, [{
    ...
    value: function getInitialProps(_ref, context) {
      ...
      var currentProduct = __WEBPACK_IMPORTED_MODULE_1_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_2__assets_config_api__["a" /* API_URL */] + __WEBPACK_IMPORTED_MODULE_2__assets_config_api__["b" /* PRODUCTS */] + 'getById', {
        method: 'POST',
        body: JSON.stringify({
          id: req.query.id
        }),
...
//# sourceMappingURL=7.c323d38ab1e5be109574.hot-update.js.map